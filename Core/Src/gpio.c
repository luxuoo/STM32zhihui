...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RELAY1_Pin|RELAY2_Pin|RELAY4_Pin|BUZZER_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PIR_Pin SMOKE_Pin */
  GPIO_InitStruct.Pin = PIR_Pin|SMOKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : DOOR_MAG_Pin */
  GPIO_InitStruct.Pin = DOOR_MAG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(DOOR_MAG_GPIO_Port, &GPIO_InitStruct);
